...
<< table_name >>Controller.$inject = ['$scope', '$stateParams', '$state', 'ngDialog', 'toaster', '$filter',  '$q','<< table_name >>'];
    function << table_name >>Controller($scope, $stateParams, $state, ngDialog, toaster, $filter, $q, << table_name >>) {
    ...
    << table_name >>EditController.$inject = ['$rootScope', '$scope', '$stateParams','$state', 'ngDialog', 'toaster', '$filter','editableOptions', 'editableThemes', '$q','SysReceiptConfig', '<< table_name >>'];
    function << table_name >>EditController($rootScope, $scope, $stateParams, $state, ngDialog, toaster, $filter, editableOptions, editableThemes, $q,SysReceiptConfig, << table_name >>) {
